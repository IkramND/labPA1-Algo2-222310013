...
int main() {
    DataMahasiswa *m[2];
    m[0] = new DataMahasiswa("Mahasiswa Aktif", "Ikram Nurhadi Damansiz", 18, "Teknologi Informasi", "Informatika dan Pariwisata");
    m[1] = new Alumni("Alumni", "Joko", 29, "Manajemen Pemasaran", "Vokasi", 2017, "Digital Marketing Manager");
